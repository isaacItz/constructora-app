...
INSERT INTO `role_edges` VALUES ('%','Recursos Humanos','%','ValdespinoIsaac81','N'),('%','Recursos Humanos','%','fdsfdsa80','N'),('%','Recursos Humanos','%','prueba1','N'),('%','Recursos Humanos','172.18.0.1','juan','N'),('%','Recursos Humanos','localhost','borra','N'),('%','Recursos Humanos','localhost','juan','N'),('%','admin','%','Recursos Humanos','N');
...
-- Dump completed on 2020-07-02  1:33:10
