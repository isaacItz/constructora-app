...
INSERT INTO `default_roles` VALUES ('%','ValdespinoIsaac81','%','Recursos Humanos'),('%','fdsfdsa80','%','Recursos Humanos'),('%','prueba1','%','Recursos Humanos'),('172.18.0.1','juan','%','Recursos Humanos'),('localhost','borra','%','Recursos Humanos'),('localhost','juan','%','Recursos Humanos');
...
-- Dump completed on 2020-07-02  1:31:47
